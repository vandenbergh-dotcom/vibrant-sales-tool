...
// Static translations for flyer UI elements
const FLYER_TRANSLATIONS: Record<Language, {
  footer: string;
  generatedBy: string;
}> = {
  en: {
    footer: "Vibrant Foods - Your trusted partner in quality ethnic foods",
    generatedBy: "Generated by Vibrant Foods Sales Tool",
  },
  hi: {
    footer: "Vibrant Foods - गुणवत्तापूर्ण एथनिक खाद्य पदार्थों में आपका विश्वसनीय साझेदार",
    generatedBy: "Vibrant Foods सेल्स टूल द्वारा निर्मित",
  },
  ur: {
    footer: "Vibrant Foods - معیاری ایتھنک فوڈز میں آپ کا قابل اعتماد ساتھی",
    generatedBy: "Vibrant Foods سیلز ٹول کے ذریعے تیار کیا گیا",
  },
};
...
export const FlyerTemplate = React.forwardRef<HTMLDivElement, FlyerTemplateProps>(
  function FlyerTemplate({ storeName, products, language, translatedNames, title, footer }, ref) {
    ...
    const translations = FLYER_TRANSLATIONS[language];
    ...
    const getPromotionText = (product: RecommendedProduct) => {
      if (!product.promotion) return null;
      // Check if we have a translated version stored as "promo_{productId}"
      if (translatedNames && translatedNames[`promo_${product.productId}`]) {
        return translatedNames[`promo_${product.productId}`];
      }
      return product.promotion.discount;
    };
      ...
      >
        ...
        <div style={{
          ...
          {products.slice(0, 12).map((product) => {
            ...
            const promoText = getPromotionText(product);
            return (
